...
2026-01-01 open Expenses:Subcontractors       USD
2026-01-01 open Expenses:Meals                USD
...
def _make_entity(tmp_dir: Path, threshold: int = 3) -> Entity:
    """Create a minimal entity directory with COA."""
    ...
    (entity_dir / "chart-of-accounts.beancount").write_text(_COA_TEXT, encoding="utf-8")
    # empty books
    (entity_dir / "books.beancount").write_text("", encoding="utf-8")
